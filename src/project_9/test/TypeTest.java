...
public class TypeTest {
    ...
    public void testBasic() throws IOException, ParseException {
        ...
        assertEquals(Type.BOOL, result.getType(body.getChild(3).getChild(1)));

        assertEquals(Type.INT, result.getType(body.getChild(5).getChild(0)));
        assertEquals(Type.BOOL, result.getType(body.getChild(7).getChild(0)));
    }
